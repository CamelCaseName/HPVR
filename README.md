...
# feature set
- [x] starts the game with SteamVR and gets output onto the HMD
- [x] you can click Buttons to advance through the intro screen and disclaimer
- [x] walk around in main menu
...
~~Connect your devices first and then start the game.~~
